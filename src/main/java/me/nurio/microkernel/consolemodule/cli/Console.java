...
import me.nurio.microkernel.MicroKernel;
import me.nurio.microkernel.consolemodule.events.ConsoleMessageInputEvent;
import me.nurio.microkernel.consolemodule.events.ConsoleMessageOutputEvent;
...
public class Console extends ConsoleUtils implements IConsole {
    ...
    private static EventManager eventManager = MicroKernel.getEventManager();
